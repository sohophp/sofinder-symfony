...
var a = /* @__PURE__ */ e(((e, t) => {
	...
	var t = o(), n = p(), r = s(), i = y(), a = _(), c = 7973, l = t.getBCHDigit(c);
	function u(t, n, r) {
	...
	e.from = function(e, t) {
		...
		if (Array.isArray(e)) {
			if (e.length > 1) return m(e, i);
			if (e.length === 0) return 1;
			n = e[0];
		} else n = e;
		return u(n.mode, n.getLength(), i);
	}, e.getEncodedBits = function(e) {
		if (!a.isValid(e) || e < 7) throw Error("Invalid QR Code version");
		let n = e << 12;
		for (; t.getBCHDigit(n) - l >= 0;) n ^= c << t.getBCHDigit(n) - l;
		return e << 12 | n;
	};
})), x = /* @__PURE__ */ e(((e) => {
	...
	var n = y(), r = /* @__PURE__ */ "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ $%*+-./:".split("");
	function i(e) {
	...
	var t = y(), n = S(), r = C(), i = w(), a = T(), s = v(), c = o(), l = E();
	function u(e) {
	...
	function f(e) {
		let n = d(s.NUMERIC, t.NUMERIC, e), r = d(s.ALPHANUMERIC, t.ALPHANUMERIC, e), i, a;
		return c.isKanjiModeEnabled() ? (i = d(s.BYTE, t.BYTE, e), a = d(s.KANJI, t.KANJI, e)) : (i = d(s.BYTE_KANJI, t.BYTE, e), a = []), n.concat(r, i, a).sort(function(e, t) {
	...
	function _(e, o) {
		let s, l = t.getBestModeForData(e);
		if (s = t.from(o, l), s !== t.BYTE && s.bit < l.bit) throw Error("\"" + e + "\" cannot be encoded with mode " + t.toString(s) + ".\n Suggested mode is: " + t.toString(l));
		switch (s === t.KANJI && !c.isKanjiModeEnabled() && (s = t.BYTE), s) {
	...
	e.fromArray = function(e) {
		...
		let r = g(h(f(t, c.isKanjiModeEnabled())), n), i = l.find_path(r.map, "start", "end"), a = [];
	...
	var t = o(), n = s(), r = c(), i = l(), a = u(), m = d(), h = f(), _ = p(), v = g(), S = b(), C = x(), w = y(), T = D();
	function E(e, t) {
		let n = e.size, r = m.getPositions(t);
	...
	function N(e, n, i) {
		...
		i.forEach(function(t) {
			a.put(t.mode.bit, 4), a.put(t.getLength(), w.getCharCountIndicator(t.mode, e)), t.write(a);
		});
		let o = (t.getSymbolTotalCodewords(e) - _.getTotalCodewordsCount(e, n)) * 8;
	...
	function P(e, n, r) {
		let i = t.getSymbolTotalCodewords(n), a = i - _.getTotalCodewordsCount(n, r), o = _.getBlocksCount(n, r), s = o - i % o, c = Math.floor(i / o), l = Math.floor(a / o), u = l + 1, d = c - l, f = new v(d), p = 0, m = Array(o), h = Array(o), g = 0, y = new Uint8Array(e.buffer);
		for (let e = 0; e < o; e++) {
			let t = e < s ? l : u;
			m[e] = y.slice(p, p + t), h[e] = f.encode(m[e]), p += t, g = Math.max(g, t);
		}
		let b = new Uint8Array(i), x = 0, S, C;
		for (S = 0; S < g; S++) for (C = 0; C < o; C++) S < m[C].length && (b[x++] = m[C][S]);
		for (S = 0; S < d; S++) for (C = 0; C < o; C++) b[x++] = h[C][S];
		return b;
	}
	function F(e, n, r, a) {
		let o;
		if (Array.isArray(e)) o = T.fromArray(e);
		else if (typeof e == "string") {
			let t = n;
			if (!t) {
				let n = T.rawSplit(e);
				t = S.getBestVersionForData(n, r);
			}
			o = T.fromString(e, t || 40);
		} else throw Error("Invalid data");
		let s = S.getBestVersionForData(o, r);
		if (!s) throw Error("The amount of data is too big to be stored in a QR Code");
		if (!n) n = s;
		else if (n < s) throw Error("\nThe chosen QR Code version cannot contain this amount of data.\nMinimum version required to store current data is: " + s + ".\n");
		let c = N(n, r, o), l = new i(t.getSymbolSize(n));
		return E(l, n), O(l), k(l, n), j(l, r, 0), n >= 7 && A(l, n), M(l, c), isNaN(a) && (a = h.getBestMask(l, j.bind(null, l, r))), h.applyMask(a, l), j(l, r, a), {
			modules: l,
			version: n,
	...
	e.create = function(e, r) {
		...
		let i = n.M, a, o;
		return r !== void 0 && (i = n.from(r.errorCorrectionLevel, n.M), a = S.from(r.version), o = h.from(r.maskPattern), r.toSJISFunc && t.setToSJISFunction(r.toSJISFunc)), F(e, a, i, o);
	};
})), k = /* @__PURE__ */ e(((e) => {
	function t(e) {
	...
	e.create = n.create, e.toCanvas = o.bind(null, r.render), e.toDataURL = o.bind(null, r.renderToDataURL), e.toString = o.bind(null, function(e, t, n) {
		return i.render(e, n);
	});
...
function I({ url: e, fileName: t, loginRequired: n, expiresAt: r, showQrCode: a, labels: o, formatDate: s, onClose: c }) {
	...
	let g = async () => {
		...
		try {
			await navigator.clipboard.writeText(e), d("copied");
		} catch {
			d("failed");
		}
	}, _ = t.replace(/[\\/:*?"<>|]+/g, "-").slice(0, 100) || "file";
	return /* @__PURE__ */ (0, F.jsxs)(i, {
		title: o.title,
		closeLabel: o.close,
		onClose: c,
		className: "sf-share-modal",
		footer: /* @__PURE__ */ (0, F.jsx)("button", {
			className: "primary",
			onClick: c,
			children: o.close
		}),
		children: [/* @__PURE__ */ (0, F.jsx)("p", {
			className: "sf-share-hint",
			children: o.hint
		}), /* @__PURE__ */ (0, F.jsxs)("div", {
			className: `sf-share-layout${a ? " has-qr" : ""}`,
			children: [/* @__PURE__ */ (0, F.jsxs)("section", {
				className: "sf-share-url",
				children: [
					/* @__PURE__ */ (0, F.jsx)("h3", { children: o.copyUrl }),
			...
			}), a && /* @__PURE__ */ (0, F.jsxs)("section", {
				className: "sf-share-qr",
				children: [
					/* @__PURE__ */ (0, F.jsx)("h3", { children: o.qrCode }),
					/* @__PURE__ */ (0, F.jsx)("div", {
						className: "sf-qr-code",
						children: m ? /* @__PURE__ */ (0, F.jsx)("p", {
							className: "sf-warning",
							role: "alert",
							children: o.qrFailed
						}) : f ? /* @__PURE__ */ (0, F.jsx)("img", {
							src: f,
							alt: o.qrCode
						}) : /* @__PURE__ */ (0, F.jsx)("div", {
							className: "sf-state",
